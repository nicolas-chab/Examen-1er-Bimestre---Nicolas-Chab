...
public class Prueba : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log("no se aplica el descuento");
        ...
        {
            Debug.Log("no se aplica el desceueto");
        ...
        {
            Debug.Log("no se aplica el desceunto");
        }
